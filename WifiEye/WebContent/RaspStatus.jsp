...
<script>
	...
	$('#p').hide();
		init();
		$.ajax({url:"mystatus?action=updateStatus",async:false});//更新状态
		initSearch();
	});
	function init() {
		$('#area').combobox({
	...
	function updateStatus(){
		...
		switch(value){
			...
			case 3:return '<img width=20px height=20px align="center" id="stateIcon" src="icon/icon_opened.png">';
		}
	}
</script>
</head>
...
<body style="margin: 1px;">
	...
	<div id="tb">
		...
		<div>
			...
			<a
				href="javascript:updateStatus()" class="easyui-linkbutton" id="updateButton"
	...
	<table id="mytable" title="mac信息列表" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th field="status_time" width="150" align="center">更新状态时间</th>
				<th field="status" width="150" align="center" formatter=formatState>设备状态</th>
			</tr>
		</thead>
	</table>
</body>
