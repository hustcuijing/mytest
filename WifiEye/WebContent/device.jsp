...
<script>
	...
	function openDeviceAddDialog() {
		$("#device_name").combobox({"disabled":false});
	...
	function openDeviceModifyDialog() {
		...
		$("#device_name").combobox({"disabled":true});
		$('#fm').form("load", row);
...
<body style="margin: 1px;">
	...
	<div id="tb">
		<br>
		<div>
			<a href="javascript:openDeviceAddDialog()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">添加</a> <a
				href="javascript:openDeviceModifyDialog()" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true">修改</a> <a
				href="javascript:deleteDevice()" class="easyui-linkbutton"
		...
		<div>
			...
			<br> <label>IP地址：  &nbsp&nbsp</label><input class="easyui-combobox" id="s_ip" name="s_ip"
				size="20" /> <a href="javascript:searchDevice()"
	...
	<table id="mytable" title="mac信息列表" class="easyui-datagrid"
		...
		url="mydevice?action=list" fit="true" toolbar="#tb">
		<thead>
			<tr>
