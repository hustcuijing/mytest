...
_4d1.pagination({total:0,my_page:1,pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_4d2,_4d3){
...
if(opts.pagination){
$.extend(_5b3,{my_page:1,page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
...
if(opts.pagination){
$.extend(_6fb,{my_page:1,page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
